class ApiEndpoints {
  ...
  static const String baseUrl = 'http://192.168.68.103:5000/api';
  //static const String baseUrl = 'http://localhost:3000/api/v1';
  // For Android Emulator use: 'http://10.0.2.2:5000/api'  //usually used
  // For iOS Simulator use: 'http://localhost:5000/api/v1'
  // For Physical Device use your computer's IP: 'http://192.168.68.103:5000/api' // use for physical device
